...
%TO DO: Ask song about bowtie2 aligning. It seems like some 'alignments'
%have 3 separate reads. Is this from sorting the bam file?

%TO DO: Command line function from Matlab.

%TO DO: Figure out issues with 'samtools sort'

%TO DO: Add unpaired reads to the same bowtie as the paired reads. Use '-U
%<m>' argument.
